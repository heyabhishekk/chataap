...
<body>
    <div class="box">
        <form method="POST" action="<?php echo e(route('registerstore')); ?>">
            <?php echo csrf_field(); ?>
            <h2>Register</h2>
            ...
            <a href="<?php echo e(route('loginview')); ?>" class="links">LOGIN</a>
...
<?php /**PATH C:\wamp64\www\chatapp\resources\views/register.blade.php ENDPATH**/ ?>