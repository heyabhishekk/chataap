                        ...
                        <?php $__currentLoopData = $user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $users): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($users->id !== auth()->id()): ?>
                                <li style="list-style: none"><i class="fa-solid fa-user"></i><span
                                        class="name-small"><?php echo e($users->name); ?></span>
                                    <a href="<?php echo e(route('chats', $users->id)); ?>" class="link chat-link"><i
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            deleteConfirmBtn.addEventListener('click', function() {
                window.location.href = "<?php echo e(route('account.delete')); ?>";
            });
...
<?php /**PATH C:\wamp64\www\chatapp\resources\views/dashboard.blade.php ENDPATH**/ ?>