...
<body>
    ...
    <div class="lgr">
        <button class="btn btn-success"><i class="fa-solid fa-right-to-bracket"></i><a
                href="<?php echo e(route('loginview')); ?>">LOGIN</a></button><br>
        <button class="btn btn-warning"><i class="fa-solid fa-right-to-bracket"></i><a
                href="<?php echo e(route('registerview')); ?>">REGISTER</a></button>
    </div>
</body>

</html>
<?php /**PATH C:\wamp64\www\chatapp\resources\views/welcome.blade.php ENDPATH**/ ?>