...
<body>
    <div class="header">
        <div class="container">
            <img src="<?php echo e(asset('images/chats.png')); ?>" alt="logo" width="370px" height="114px">
            <div class="header-right">
                <a class="active" href="<?php echo e(route('dashboard')); ?>"><i class="fa-solid fa-house"></i>Home</a>
                <a href="<?php echo e(route('logout')); ?>" style="background-color: darkgoldenrod"><i
    ...
    <div class="container">
        ...
        <div class="card-body" id="chatbox">
            <?php $__currentLoopData = $user->messages()->where('user_id', $user->id)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="chat-message <?php echo e($message->user_id == $user->id ? 'sent' : 'received'); ?>">
                    <strong><?php echo e($message->user->name); ?></strong>: <?php echo e($message->content); ?>
    ...
    <div class="card-footer">
        <form id="chatForm" method="POST" action="<?php echo e(route('send-message')); ?>">
            <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        function getMessages(userId) {
            ...
            $.ajax({
                type: 'GET',
                url: '<?php echo e(route('get-messages')); ?>',
                data: {
                    userId: userId
                },
                success: function(response) {
...
<?php /**PATH C:\wamp64\www\chatapp\resources\views/chat.blade.php ENDPATH**/ ?>